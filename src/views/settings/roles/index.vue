<template>
  <div class="app-container">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-tooltip content="编辑" placement="top">
                <el-button type="text" icon="el-icon-edit-outline" @click="onEditRole(scope.row.id)"></el-button>
              </el-tooltip>
    ...
    <el-dialog title="编辑角色" width="30%" :visible.sync="dialogVisible">
      ...
      <div class="dialog-footer" slot="footer">
        ...
        <el-button type="primary" icon="el-icon-check" @click="onUpdateRole">确认修改</el-button>
      </div>
    </el-dialog>
  </div>
</template>
